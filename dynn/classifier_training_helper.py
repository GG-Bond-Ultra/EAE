...
class ClassifierTrainingHelper:
    ...
    def get_loss(self, inputs: torch.Tensor, targets: torch.tensor, compute_hamming = False):
        ...
        num_exits_per_gate = []
        final_head0, final_head1, intermediate_outs0, intermediate_outs1 = self.net.module.forward_features(inputs)
        ...
        for l, intermediate_head in enumerate(self.net.module.intermediate_heads):
            current_logits0 = intermediate_head(intermediate_outs0[l])
            current_logits1 = self.net.module.intermediate_heads_dist[l](intermediate_outs1[l])
