...
class GateTrainingHelper:
    def __init__(self, net: nn.Module, gate_objective: GateObjective, G: int, device) -> None:
        ...
        self.gate_objective = GateObjective.CrossEntropy
    ...
    def get_loss(self, inputs: torch.Tensor, targets: torch.tensor):
        final_head0, final_head1, intermediate_zs0, intermediate_zs1 = self.net.module.forward_features(inputs)
        final_logits = (self.net.module.head(final_head0) + self.net.module.head_dist(final_head1)) / 2
        intermediate_losses = []
        gate_logits = []
        intermediate_logits = []
        ...
        for l, intermediate_head in enumerate(self.net.module.intermediate_heads):
            ...
            current_logits0 = intermediate_head(intermediate_zs0[l])
            current_logits1 = self.net.module.intermediate_heads_dist[l](intermediate_zs1[l])
            current_logits = (current_logits0 + current_logits1) / 2
